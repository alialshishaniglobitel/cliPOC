...
public class MaxSequenceNumberTest {
	...
	private class ClientAssociationListener implements AssociationListener {
		...
		public void onPayload(Association association, PayloadData payloadData) {
			...
			MyLoggerFactory.getInstance().getAPILogger().debug("CLIENT received " + new String(clientMessage));
		...
		public void inValidStreamId(PayloadData payloadData) {
			...
			MyLoggerFactory.getInstance().getAPILogger().error(String.format("Tx : PayloadData with streamNumber=%d which is greater than or equal to maxSequenceNumber=%d. Droping PayloadData=%s",
	...
	private class ServerAssociationListener implements AssociationListener {
		...
		public void onPayload(Association association, PayloadData payloadData) {
			...
			// MyLoggerFactory.getInstance().getAPILogger().debug("SERVER received " new String(serverMessage));
	...
	private class DataSender implements Runnable {
		...
		public void run() {
			...
			MyLoggerFactory.getInstance().getAPILogger().info("Set maxSequenceNumber = " + this.maxSequenceNumber);
