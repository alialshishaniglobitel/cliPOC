...
//        this.management3.setSingleThread(true);
    ...
    public void testAnonymousTcp() throws Exception {
        ...
        // Logger logger = MyLoggerFactory.getInstance().getAPILogger().getLogger(ServerImpl.class.getName());
        // MyLoggerFactory.getInstance().getAPILogger().setLevel(Level.ALL);
    ...
    private class ServerAssociationListener implements AssociationListener {
        ...
        public void onPayload(Association association, PayloadData payloadData) {
            ...
            MyLoggerFactory.getInstance().getAPILogger().debug("SERVER received " + new String(assData.rsvdMsg));
        }
    ...
    private class ClientAssociationListener implements AssociationListener {
        ...
        public void onPayload(Association association, PayloadData payloadData) {
            assData.rsvdMsg = new byte[payloadData.getDataLength()];
            payloadData.getByteBuf().readBytes(assData.rsvdMsg);
            MyLoggerFactory.getInstance().getAPILogger().debug("CLIENT received " + new String(assData.rsvdMsg));
        }
